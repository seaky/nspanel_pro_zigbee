...
const schneiderElectricExtend = {
    ...
    dimmingMode: () => {
        const extend = (0, modernExtend_1.enumLookup)({
            name: 'dimmer_mode',
            lookup: {
                Auto: 0,
                'RL-LED': 3,
        ...
        extend.configure.push((0, modernExtend_1.setupConfigureForReading)('lightingBallastCfg', ['wiserControlMode']));
        return extend;
    },
    addOccupancyConfigurationCluster: () => (0, modernExtend_1.deviceAddCustomCluster)('occupancyConfiguration', {
        ID: 0xff19,
        manufacturerCode: zigbee_herdsman_1.Zcl.ManufacturerCode.SCHNEIDER_ELECTRIC,
        attributes: {
    ...
    occupancyConfiguration: () => {
        ...
        const luxThresholdExtend = (0, modernExtend_1.numeric)({
        ...
        extend.configure.push((0, modernExtend_1.setupConfigureForReading)('occupancyConfiguration', ['ambienceLightThreshold']));
        return extend;
    },
};
const tzLocal = {
...
const definitions = [
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.lightingBallast)(),
