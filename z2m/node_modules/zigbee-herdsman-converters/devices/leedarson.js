...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off, fromZigbee_1.default.CCTSwitch_D0001_levelctrl, fromZigbee_1.default.CCTSwitch_D0001_lighting, fromZigbee_1.default.battery],
        exposes: [
            e.battery(),
            e.action([
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.occupancy, fromZigbee_1.default.ignore_occupancy_report],
        toZigbee: [],
        exposes: [e.occupancy()],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity, fromZigbee_1.default.ignore_occupancy_report],
        toZigbee: [],
