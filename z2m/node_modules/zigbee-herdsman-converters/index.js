...
function removeFromLookup(zigbeeModel, definition) {
    const lookupModel = zigbeeModel ? zigbeeModel.toLowerCase() : 'null';
    if (lookup.has(lookupModel)) {
...
function validateDefinition(definition) {
    for (const [field, expectedType] of Object.entries(converterRequiredFields)) {
        ...
        (0, assert_1.default)(val !== null, `Converter field ${field} is null`);
        (0, assert_1.default)(val !== undefined, `Converter field ${field} is undefined`);
        (0, assert_1.default)(val.constructor.name === expectedType, `Converter field ${field} expected type doenst match to ${val}`);
    }
...
function removeExternalDefinitions(converterName) {
    for (let i = 0; i < externalDefinitionsCount; i++) {
        const definition = exports.definitions[i];
        ...
        exports.definitions.splice(i, 1);
...
function findByModel(model) {
    ...
    */
    ...
    return exports.definitions.find((definition) => {
        return (definition.model.toLowerCase() == model ||
