...
const definitions = [
    {
        ...
        extend: [sengledLight(), (0, modernExtend_1.iasZoneAlarm)({ zoneType: 'occupancy', zoneAttributes: ['alarm_1'] })],
        ota: true,
    },
    {
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.forcePowerSource)({ powerSource: 'Mains (single phase)' }), sengledLight(), (0, modernExtend_1.electricityMeter)({ cluster: 'metering' })],
        ota: true,
    },
    {
    ...
    },
    {
        ...
        extend: [sengledLight({ colorTemp: { range: [154, 500] } }), (0, modernExtend_1.electricityMeter)({ cluster: 'metering' })],
        ota: true,
    },
    {
    ...
    },
    {
        ...
        extend: [sengledLight(), (0, modernExtend_1.electricityMeter)({ cluster: 'metering' })],
        ota: true,
    },
    {
        zigbeeModel: ['E13-A21'],
