...
exports.valueConverter = {
    ...
    PO_BOCO_ELEC_holiday: {
        to: (v) => {
            ...
            const startDate = new Date(parseInt(startYear), parseInt(startMonth) - 1, parseInt(startDay), parseInt(startHours), parseInt(startMinutes));
            ...
            payload.push(parseInt(startYear.slice(2)), parseInt(startMonth), parseInt(startDay), parseInt(startHours), parseInt(startMinutes), modeMapping[mode], 0, diffHours);
            return payload;
        },
        from: (v) => {
