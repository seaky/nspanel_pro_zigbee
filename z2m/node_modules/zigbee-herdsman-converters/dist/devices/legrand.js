...
exports.definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fz.identify, fz.legrand_binary_input_moving, fz.cover_position_tilt, legrand_1.fzLegrand.cluster_fc01],
    ...
    },
    {
        ...
        fromZigbee: [fz.legrand_scenes, fz.legrand_master_switch_center, fz.battery, legrand_1.fzLegrand.stop_poll_on_checkin],
        toZigbee: [],
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.metering, fz.electrical_measurement, fz.legrand_power_alarm, legrand_1.fzLegrand.cluster_fc01],
    ...
    },
    {
        ...
        ota: true,
        fromZigbee: [fz.identify, fz.legrand_binary_input_on_off, legrand_1.fzLegrand.cluster_fc01],
        toZigbee: [legrand_1.tzLegrand.identify, legrand_1.tzLegrand.led_mode],
        exposes: [e.switch().withEndpoint("left"), e.switch().withEndpoint("right"), legrand_1.eLegrand.ledInDark(), legrand_1.eLegrand.ledIfOn()],
