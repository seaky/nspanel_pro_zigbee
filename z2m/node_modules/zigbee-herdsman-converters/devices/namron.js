...
const fzLocal = {
    ...
    namron_thermostat2: {
        ...
        convert: (model, msg, publish, options, meta) => {
            ...
            return fromZigbee_1.default.thermostat.convert(model, msg, publish, options, meta); // as KeyValue;
        },
    },
};
const tzLocal = {
...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fzLocal.namron_thermostat2, fromZigbee_1.default.metering, fromZigbee_1.default.electrical_measurement, fromZigbee_1.default.namron_hvac_user_interface],
        toZigbee: [
            {
                // map running *mode* to *state*, as that's what used
                // in homeAssistant climate ui card (red background)
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.ias_occupancy_alarm_1, fromZigbee_1.default.battery, fromZigbee_1.default.temperature, fromZigbee_1.default.humidity],
        toZigbee: [],
