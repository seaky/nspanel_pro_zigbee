...
const definitions = [
    ...
    },
    {
        ...
        toZigbee: [toZigbee_1.default.thermostat_occupied_heating_setpoint, toZigbee_1.default.elko_power_status, toZigbee_1.default.elko_relay_state, toZigbee_1.default.elko_local_temperature_calibration],
        extend: [
            (0, modernExtend_1.text)({
                name: 'display_text',
