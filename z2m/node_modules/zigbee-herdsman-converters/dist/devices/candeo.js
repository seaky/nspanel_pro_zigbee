            ...
            m.deviceAddCustomCluster("candeoRotaryRemoteControl", {
                ...
                commands: {
                    rotaryRemoteControl: {
                        ID: 0x01,
                        parameters: [
                            { name: "field1", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                            { name: "field2", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                            { name: "field3", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                            { name: "field4", type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
                        ],
                    },
                },
                commandsResponse: {},
