        ...
        convertSet: async (entity, key, value, meta) => {
            switch (key) {
                ...
                case 'holiday_temp_set':
                    await entity.write('hvacThermostat', { 0x8013: Number(value) * 100, type: zigbee_herdsman_1.Zcl.DataType.INT16 });
                    break;
                case 'holiday_temp_set_f':
                    await entity.write('hvacThermostat', { 0x801b: Number(value) * 100, type: zigbee_herdsman_1.Zcl.DataType.INT16 });
                    break;
            }
        },
        convertGet: async (entity, key, meta) => {
...
exports.edgeThermostat = {
    ...
    regulatorPercentage: (args) => modernExtend.numeric({
        ...
        cluster: 'hvacThermostat',
        attribute: { ID: 0x801d, type: zigbee_herdsman_1.Zcl.DataType.UINT8 },
