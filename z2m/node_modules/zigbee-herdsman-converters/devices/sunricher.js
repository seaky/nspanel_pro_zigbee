...
const definitions = [
    {
        ...
        extend: [(0, modernExtend_1.light)(), (0, modernExtend_1.electricityMeter)(), (0, modernExtend_1.commandsScenes)()],
    },
    {
        ...
        extend: [(0, modernExtend_1.battery)(), (0, modernExtend_1.commandsOnOff)(), (0, modernExtend_1.commandsLevelCtrl)(), (0, modernExtend_1.commandsWindowCovering)(), (0, modernExtend_1.commandsColorCtrl)()],
    },
    {
        zigbeeModel: ['ZG9032B'],
        model: 'SR-ZG9033TH',
        ...
        extend: [
            ...
            (0, modernExtend_1.humidity)({ endpointNames: ['2'] }),
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.battery)(), sunricherSRZG9002K16Pro()],
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_1.illuminance)({ endpointNames: ['3'] }),
    ...
    },
    {
        ...
        vendor: 'Sunricher',
        description: 'Zigbee smart remote',
        extend: [(0, modernExtend_1.battery)(), sunricherSRZG2836D5Pro()],
    },
    {
        ...
        vendor: 'Sunricher',
        description: 'Zigbee smart wall panel remote',
        extend: [(0, modernExtend_1.battery)(), sunricherSRZG9002KR12Pro()],
    },
    {
