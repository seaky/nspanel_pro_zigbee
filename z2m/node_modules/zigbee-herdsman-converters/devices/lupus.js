...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.onOff)({ powerOnBehavior: false, ota: true })],
    },
    {
        ...
        extend: [(0, modernExtend_1.deviceEndpoints)({ endpoints: { l1: 1, l2: 2 } }), (0, modernExtend_1.onOff)({ endpointNames: ['l1', 'l2'], powerOnBehavior: false, ota: true })],
    },
];
