...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.terncy_temperature, fromZigbee_1.default.occupancy_with_timeout, fromZigbee_1.default.illuminance, fromZigbee_1.default.terncy_raw, fromZigbee_1.default.battery],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.terncy_raw, fromZigbee_1.default.terncy_knob, fromZigbee_1.default.battery],
        toZigbee: [],
        ota: true,
        meta: { battery: { dontDividePercentage: true } },
