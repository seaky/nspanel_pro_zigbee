...
const definitions = [
    ...
    },
    {
        ...
        extend: [
            (0, modernExtend_1.deviceAddCustomCluster)('customClusterEwelink', {
                ID: 0xef00,
                attributes: {},
                commands: {
                    protocolData: {
            ...
            (0, modernExtend_1.windowCovering)({
                controls: ['lift'],
        ...
        configure: async (device, coordinatorEndpoint) => {
            ...
            await (0, modernExtend_1.setupAttributes)(device, coordinatorEndpoint, 'closuresWindowCovering', windowCoveringAttributes);
        },
