...
const definitions = [
    {
        ...
        extend: [(0, philips_1.philipsLight)({ colorTemp: { range: [153, 454] }, color: true })],
    },
    {
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.command_on, fromZigbee_1.default.command_off_with_effect, fromZigbee_1.default.command_step, fromZigbee_1.default.hue_smart_button_event, fromZigbee_1.default.battery],
        toZigbee: [],
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.battery, fromZigbee_1.default.occupancy, fromZigbee_1.default.temperature, fromZigbee_1.default.occupancy_timeout, fromZigbee_1.default.hue_motion_sensitivity, fromZigbee_1.default.hue_motion_led_indication],
        exposes: [
            e.temperature(),
            e.occupancy(),
            e.battery(),
    ...
    },
    {
        ...
        vendor: 'Philips',
        description: 'Hue white ambiance Aurelle round panel light',
        extend: [m.identify(), (0, philips_1.philipsLight)({ colorTemp: { range: [153, 454] } })],
    },
    {
