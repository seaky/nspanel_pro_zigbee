...
const definitions = [
    ...
    },
    {
        ...
        fromZigbee: [fromZigbee_1.default.STS_PRS_251_presence, fromZigbee_1.default.battery, fromZigbee_1.default.identify],
        exposes: [
            e.battery(),
            e.presence(),
            e.action(['identify']),
    ...
    },
    {
        ...
        vendor: 'SmartThings',
        description: 'Button',
        fromZigbee: [fromZigbee_1.default.command_status_change_notification_action, fromZigbee_1.default.battery, fromZigbee_1.default.temperature, fromZigbee_1.default.ignore_iaszone_attreport],
